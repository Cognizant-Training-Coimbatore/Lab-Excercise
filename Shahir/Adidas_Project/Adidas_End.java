...
public class Adidas_End
{
	...
	public void fullscript() throws InterruptedException, IOException
	{
	    ...
	    String a = excel.excelRead("/Users/shahir/eclipse-workspace/Adidas_Project/SignUp.xlsx", 3, 0);
    	String b = excel.excelRead("/Users/shahir/eclipse-workspace/Adidas_Project/SignUp.xlsx", 3, 1);
    	String c = excel.excelRead("/Users/shahir/eclipse-workspace/Adidas_Project/search.xlsx", 0, 0);
	...
	public void fullscript2() throws InterruptedException, IOException
	{
	    ...
	    String a = excel.excelRead("/Users/shahir/eclipse-workspace/Adidas_Project/SignUp.xlsx", 3, 0);
    	String b = excel.excelRead("/Users/shahir/eclipse-workspace/Adidas_Project/SignUp.xlsx", 3, 1);
    	String c = excel.excelRead("/Users/shahir/eclipse-workspace/Adidas_Project/search.xlsx", 1, 0);
		driver.findElement(signinuser).sendKeys(a);
		driver.findElement(signinpassword).sendKeys(b);
		driver.findElement(clicklogin).click();
		TimeUnit.SECONDS.sleep(7);
